...
import com.engineblue.presentation.useCases.GetRemoteProductsImpl
import com.engineblue.presentation.useCases.GetRemoteStationsImpl
import com.engineblue.presentation.useCases.preferences.GetSavedProductImpl
import com.engineblue.presentation.useCases.preferences.SaveProductSelectedImpl
...
val mViewModels = module {
    ...
    viewModel {
        ListStationsViewModel(getRemoteStations = get(), getSavedProduct = get(), saveProductSelected = get())
    }
}
